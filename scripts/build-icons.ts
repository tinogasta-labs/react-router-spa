...
if (files.length === 0) {
  // biome-ignore lint/suspicious/noConsole: No files log
...
async function generateIconFiles() {
  ...
  const typeOutputContent = `// This file is generated by pnpm build:icons
...
`,
  ...
  if (spriteChanged || typesChanged || readmeChanged) {
    // biome-ignore lint/suspicious/noConsole: Count svgs log
